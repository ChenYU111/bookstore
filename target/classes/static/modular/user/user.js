...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '专业', field: 'major', align: 'center', valign: 'middle', sortable: true},
        {title: '角色', field: 'profession', align: 'center', valign: 'middle', sortable: true},
...
/*MgrUser.delMgrUser = function () {
    if (this.check()) {
        ...
        layer.confirm("是否删除用户" + MgrUser.seItem.account + "?",operation);
    }
};
*/
/**
